---
id: TableResourceTableThroughput
title: TableResourceTableThroughput
---
Provides a **TableResourceTableThroughput** from the **DocumentDB** group
## Examples
...
- [TableResourceTable](../DocumentDB/TableResourceTable.md)
## Swagger Schema
```js
{
