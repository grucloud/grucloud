---
id: CassandraResourceCassandraTableThroughput
title: CassandraResourceCassandraTableThroughput
---
Provides a **CassandraResourceCassandraTableThroughput** from the **DocumentDB** group
## Examples
### CosmosDBCassandraTableThroughputUpdate
```js
exports.createResources = () => [
  {
    type: "CassandraResourceCassandraTableThroughput",
    group: "DocumentDB",
    name: "myCassandraResourceCassandraTableThroughput",
    properties: () => ({
      location: "West US",
      tags: {},
    ...
    dependencies: ({}) => ({
      ...
      table: "myCassandraResourceCassandraTable",
    }),
  },
];
