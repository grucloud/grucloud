---
id: CassandraResourceCassandraKeyspaceThroughput
title: CassandraResourceCassandraKeyspaceThroughput
---
Provides a **CassandraResourceCassandraKeyspaceThroughput** from the **DocumentDB** group
## Examples
### CosmosDBCassandraKeyspaceThroughputUpdate
```js
exports.createResources = () => [
  {
    type: "CassandraResourceCassandraKeyspaceThroughput",
    group: "DocumentDB",
    name: "myCassandraResourceCassandraKeyspaceThroughput",
    properties: () => ({
      location: "West US",
      tags: {},
