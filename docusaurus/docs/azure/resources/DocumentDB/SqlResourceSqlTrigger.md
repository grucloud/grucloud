---
id: SqlResourceSqlTrigger
title: SqlResourceSqlTrigger
---
Provides a **SqlResourceSqlTrigger** from the **DocumentDB** group
## Examples
      ...
      properties: {
        resource: {
          ...
          properties: {
            ...
            body: { type: 'string', description: 'Body of the Trigger' },
            triggerType: {
              type: 'string',
              enum: [ 'Pre', 'Post' ],
              description: 'Type of the Trigger',
              'x-ms-enum': { name: 'triggerType', modelAsString: true }
            },
            triggerOperation: {
              type: 'string',
              enum: [ 'All', 'Create', 'Update', 'Delete', 'Replace' ],
              description: 'The operation the trigger is associated with',
              'x-ms-enum': { name: 'triggerOperation', modelAsString: true }
            }
          },
          required: [ 'id' ]
        },
