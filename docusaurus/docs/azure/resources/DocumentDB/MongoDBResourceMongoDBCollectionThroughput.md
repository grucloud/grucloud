---
id: MongoDBResourceMongoDBCollectionThroughput
title: MongoDBResourceMongoDBCollectionThroughput
---
Provides a **MongoDBResourceMongoDBCollectionThroughput** from the **DocumentDB** group
## Examples
...
- [MongoDBResourceMongoDBCollection](../DocumentDB/MongoDBResourceMongoDBCollection.md)
## Swagger Schema
```js
{
