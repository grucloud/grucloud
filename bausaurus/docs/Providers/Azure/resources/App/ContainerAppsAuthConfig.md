---
id: ContainerAppsAuthConfig
title: ContainerAppsAuthConfig
---
Provides a **ContainerAppsAuthConfig** from the **App** group
## Examples
...
The Swagger schema used to generate this documentation can be found [here](https://github.com/Azure/azure-rest-api-specs/tree/main/specification/app/resource-manager/Microsoft.App/stable/2022-03-01/AuthConfigs.json).
