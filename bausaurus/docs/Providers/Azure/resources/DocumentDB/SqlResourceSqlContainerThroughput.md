---
id: SqlResourceSqlContainerThroughput
title: SqlResourceSqlContainerThroughput
---
Provides a **SqlResourceSqlContainerThroughput** from the **DocumentDB** group
## Examples
### CosmosDBSqlContainerThroughputUpdate
```js
exports.createResources = () => [
  {
    type: "SqlResourceSqlContainerThroughput",
    group: "DocumentDB",
    name: "mySqlResourceSqlContainerThroughput",
    properties: () => ({
      location: "West US",
      tags: {},
