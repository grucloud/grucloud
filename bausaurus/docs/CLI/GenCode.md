...
Options:
  ...
  --resource-group <value>     Azure only: Filter by resource groups, multiple values allowed
  ...
  --outputEnv <file>           default.env environment variables (default: "default.template.env")
