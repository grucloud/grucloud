...
exports.createResources = async ({ provider, resources }) => {
  ...
  const awsLoadBalancerControllerServiceAccount = await provider.makeServiceAccount(
    {
  ...
  const awsLoadBalancerControllerLeaderElectionRoleRole = await provider.makeRole(
    {
  ...
  const awsLoadBalancerControllerLeaderElectionRolebindingRoleBinding = await provider.makeRoleBinding(
    {
  ...
  const awsLoadBalancerWebhookServiceService = await provider.makeService({
    name: "aws-load-balancer-webhook-service",
    properties: () => ({
      apiVersion: "v1",
      metadata: {
            ...
            containers: [
              {
                args: [
                  ...
                  `--aws-region=${provider.dependencies.aws.config.region}`,
                  "--ingress-class=alb",
                ],
  ...
  const awsLoadBalancerServingCertCertificate = await provider.makeCertificate({
  ...
  const awsLoadBalancerSelfsignedIssuerIssuer = await provider.makeIssuer({
    name: "aws-load-balancer-selfsigned-issuer",
    properties: () => ({
      apiVersion: "cert-manager.io/v1alpha2",
      metadata: {
  ...
  return {
    ...
    awsLoadBalancerControllerLeaderElectionRoleRole,
    awsLoadBalancerControllerRoleClusterRole,
    awsLoadBalancerControllerLeaderElectionRolebindingRoleBinding,
    awsLoadBalancerControllerRolebindingClusterRoleBinding,
    awsLoadBalancerWebhookServiceService,
    awsLoadBalancerControllerDeployment,
    awsLoadBalancerServingCertCertificate,
    awsLoadBalancerSelfsignedIssuerIssuer,
