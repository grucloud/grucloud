...
const createResources = ({ provider }) => {
  provider.iam.makeServiceAccount({
    name: get("config.iam.ServiceAccount.saSaTestExample.name"),
    properties: get("config.iam.ServiceAccount.saSaTestExample.properties"),
  });
  ...
  provider.iam.makeBinding({
    name: get("config.iam.Binding.rolesFirebasenotificationsViewer.name"),
    properties: get(
      "config.iam.Binding.rolesFirebasenotificationsViewer.properties"
    ),
  });
