...
exports.createResources = () => [
        ...
        Statement: [
          {
            Effect: "Allow",
            Principal: {
              Federated: `arn:aws:iam::${config.accountId()}:saml-provider/my-saml-provider`,
            },
            Action: "sts:AssumeRoleWithSAML",
            Condition: {
              StringEquals: {
                "SAML:aud": "grucloud.org",
              },
            },
          },
        ],
  ...
  },
  {
    ...
    properties: ({}) => ({
      ...
      SAMLMetadataDocument: `<?xml version="1.0" encoding="UTF-8"?><md:EntityDescriptor xmlns:md="urn:oasis:names:tc:SAML:2.0:metadata" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" entityID="https://terraform-dev-ed.my.salesforce.com" validUntil="2025-09-02T18:27:19.710Z">
