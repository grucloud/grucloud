  ...
  },
  {
    ...
    properties: ({}) => ({
      LaunchTemplateData: {
        ...
        UserData:
          'MIME-Version: 1.0\nContent-Type: multipart/mixed; boundary="//"\n\n--//\nContent-Type: text/x-shellscript; charset="us-ascii"\n#!/bin/bash\nset -ex\nB64_CLUSTER_CA=\nAPI_SERVER_URL=https://F831A67AE559B8C83F7967799224C7EF.gr7.us-east-1.eks.amazonaws.com\nK8S_CLUSTER_DNS_IP=10.100.0.10\n/etc/eks/bootstrap.sh my-cluster --kubelet-extra-args \'--node-labels=eks.amazonaws.com/sourceLaunchTemplateVersion=1,alpha.eksctl.io/cluster-name=my-cluster,alpha.eksctl.io/nodegroup-name=ng-1,eks.amazonaws.com/nodegroup-image=ami-0595cbb9fda4ac83b,eks.amazonaws.com/capacityType=ON_DEMAND,eks.amazonaws.com/nodegroup=ng-1,eks.amazonaws.com/sourceLaunchTemplateId=lt-01384faf5cda68b8c --max-pods=17\' --b64-cluster-ca $B64_CLUSTER_CA --apiserver-endpoint $API_SERVER_URL --dns-cluster-ip $K8S_CLUSTER_DNS_IP --use-max-pods false\n\n--//--',
        MetadataOptions: {
          HttpTokens: "optional",
          HttpPutResponseHopLimit: 2,
        },
        Image: {
          Description:
            "EKS Kubernetes Worker AMI with AmazonLinux2 image, (k8s: 1.23.9, docker: 20.10.17-1.amzn2.0.1, containerd: 1.6.6-1.amzn2.0.2)",
        },
      },
    }),
    dependencies: ({}) => ({
