...
exports.createResources = () => [
  ...
  },
  {
    ...
    properties: ({}) => ({
      ...
      EarliestBacktrackTime: "2022-04-06T18:18:44.973Z",
  ...
  },
  {
    ...
    properties: ({}) => ({
      ...
      //EnablePerformanceInsights must be set to true in PerformanceInsightsEnabled
  ...
  //   type: "DBInstance",
  //   group: "RDS",
  //   name: "sam-app-mysql-node-2",
  //   properties: ({}) => ({
  //     DBInstanceClass: "db.r5.large",
  //     Engine: "aurora-mysql",
  //     MasterUsername: process.env.SAM_APP_MYSQL_NODE_2_MASTER_USERNAME,
  //     DBName: "mylab",
  //     AllocatedStorage: 20,
  //     PreferredBackupWindow: "04:46-05:16",
  //     PreferredMaintenanceWindow: "sat:03:22-sat:03:52",
  //     EngineVersion: "5.7.mysql_aurora.2.09.1",
  //     PubliclyAccessible: false,
  //     StorageType: "aurora",
  //     StorageEncrypted: true,
  ...
  //     PerformanceInsightsRetentionPeriod: 7,
  //     EnabledCloudwatchLogsExports: ["error", "slowquery"],
  //     MasterUserPassword: process.env.SAM_APP_MYSQL_NODE_2_MASTER_USER_PASSWORD,
  //   }),
  //   dependencies: () => ({
  //     dbSubnetGroup: "sam-app-db-subnet-group",
  //     securityGroups: ["sam-app-database-sg"],
