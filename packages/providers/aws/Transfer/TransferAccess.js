...
exports.TransferAccess = () => ({
  ...
  // ],
  // https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/Transfer.html#getAccess-property
  getById: {
    method: "getAccess",
    getField: "Access",
    pickId,
  ...
  // https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/Transfer.html#listAccesss-property
  getList: {
  ...
  create: {
    ...
    method: "createAccess",
    pickCreated: ({ payload }) => pipe([get("Access")]),
