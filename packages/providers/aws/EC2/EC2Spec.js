...
const { EC2ClientKeyPair } = require("./EC2KeyPair");
...
const { EC2Volume, setupEbsVolume } = require("./EC2Volume");
...
module.exports = pipe([
  () => [
    ...
    {
      type: "SecurityGroupRuleIngress",
      Client: EC2SecurityGroupRuleIngress,
    ...
    {
      type: "SecurityGroupRuleEgress",
      Client: EC2SecurityGroupRuleEgress,
      compare: compareSecurityGroupRule,
      filterLive: securityGroupRulePickProperties,
      dependencies: securityGroupRuleDependencies,
