...
exports.DataSyncLocationFsxOpenZfs = () => ({
  ...
  // https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/DataSync.html#describeLocationFsxOpenZfs-property
  getById: {
    method: "describeLocationFsxOpenZfs",
    pickId,
    decorate,
  },
  ...
  getList: {
    enhanceParams: () =>
      pipe([
        () => ({
          Filters: [
            { Name: "LocationType", Operator: "Contains", Values: ["ZFS"] }, // TODO
          ],
        }),
      ]),
  ...
  // https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/DataSync.html#createLocationFsxOpenZfs-property
  create: {
    method: "createLocationFsxOpenZfs",
    pickCreated: ({ payload }) => pipe([identity]),
  },
  // https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/DataSync.html#deleteLocationFsxOpenZfs-property
  destroy: {
