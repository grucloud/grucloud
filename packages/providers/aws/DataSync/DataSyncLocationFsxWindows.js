...
exports.DataSyncLocationFsxWindows = ({ compare }) => ({
  ...
  // https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/DataSync.html#createLocationFsxWindows-property
  create: {
    method: "createLocationFsxWindows",
    pickCreated: ({ payload }) => pipe([identity]),
  },
  // https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/DataSync.html#deleteLocationFsxWindows-property
  destroy: {
