// Generated by k8s-manifest2code from aws-load-balancer-controller.yaml
const assert = require("assert");
exports.createResources = async ({ provider, resources }) => {
  const targetgroupbindingsElbv2K8sAwsCustomResourceDefinition = await provider.makeCustomResourceDefinition(
    {
  ...
  const awsLoadBalancerWebhookMutatingWebhookConfiguration = await provider.makeMutatingWebhookConfiguration(
    {
  ...
  const kubeSystemawsLoadBalancerControllerLeaderElectionRoleRole = await provider.makeRole(
    {
  ...
  const awsLoadBalancerControllerRoleClusterRole = await provider.makeClusterRole(
    {
  ...
  const kubeSystemawsLoadBalancerControllerLeaderElectionRolebindingRoleBinding = await provider.makeRoleBinding(
    {
      name:
  ...
  const awsLoadBalancerControllerRolebindingClusterRoleBinding = await provider.makeClusterRoleBinding(
    {
  ...
  const kubeSystemawsLoadBalancerWebhookServiceService = await provider.makeService(
    {
  ...
  const kubeSystemawsLoadBalancerServingCertCertificate = await provider.makeCertificate(
    {
  ...
  const kubeSystemawsLoadBalancerSelfsignedIssuerIssuer = await provider.makeIssuer(
    {
  ...
  const awsLoadBalancerWebhookValidatingWebhookConfiguration = await provider.makeValidatingWebhookConfiguration(
    {
      name: "aws-load-balancer-webhook",
      properties: () => ({
        apiVersion: "admissionregistration.k8s.io/v1beta1",
  ...
  return {
    targetgroupbindingsElbv2K8sAwsCustomResourceDefinition,
    awsLoadBalancerWebhookMutatingWebhookConfiguration,
    kubeSystemawsLoadBalancerControllerServiceAccount,
    kubeSystemawsLoadBalancerControllerLeaderElectionRoleRole,
    awsLoadBalancerControllerRoleClusterRole,
    kubeSystemawsLoadBalancerControllerLeaderElectionRolebindingRoleBinding,
    awsLoadBalancerControllerRolebindingClusterRoleBinding,
    kubeSystemawsLoadBalancerWebhookServiceService,
    kubeSystemawsLoadBalancerControllerDeployment,
    kubeSystemawsLoadBalancerServingCertCertificate,
    kubeSystemawsLoadBalancerSelfsignedIssuerIssuer,
    awsLoadBalancerWebhookValidatingWebhookConfiguration,
  };
};
