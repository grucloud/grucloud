...
exports.createResources = async ({ provider, resources }) => {
  const targetgroupbindingsElbv2K8sAwsCustomResourceDefinition =
  ...
  const awsLoadBalancerWebhookMutatingWebhookConfiguration =
    provider.makeMutatingWebhookConfiguration({
  ...
  const awsLoadBalancerControllerRoleClusterRole = provider.makeClusterRole({
  ...
  const awsLoadBalancerControllerRolebindingClusterRoleBinding =
  ...
  const awsLoadBalancerWebhookValidatingWebhookConfiguration =
    provider.makeValidatingWebhookConfiguration({
      name: "aws-load-balancer-webhook",
      properties: () => ({
        apiVersion: "admissionregistration.k8s.io/v1beta1",
        metadata: {
